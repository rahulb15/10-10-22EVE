...
export default function FullScreenDialog(props) {
  // console.log("AddDialogprops", props);
  ...
  const handleSubmits = (e) => {
    ...
    axios
      .post("http://localhost:3002/api/portfolio", data, {
        headers: {
          ...
          <div style={{ width: "100%", marginLeft: "10px", height: "100%" ,marginTop:20 ,marginBottom:20}}>
            ...
            <Multiselect
              ...
              onSelect={(selectedList, selectedItem) => {
                ...
                //     ...data.feature,
                //     [item.name]: selected,
                //       // [data.feature[item.name]]: [selectedItem.name],
                //       // [props.key]: e.target.checked,
                //   },
                // });
              }}
  ...
  return (
    <div>
      ...
      >
        <AppBar sx={{ position: "relative", backgroundColor: "#4db6ac" }}>
          <Toolbar>
